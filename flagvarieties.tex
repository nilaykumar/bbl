...
% TODO define algebraic vector bundles
% TODO define equivariant vector bundles
% TODO association between algebraic vector bundles and locally free sheaves
...
We return to the proof of proposition \ref{principalBbundle}. Note that $\pi^{-1}(N^-B / B) = N^- B$; we prove
...
We follow the motivation of Chriss and Ginzburg \sidenote{cite here} for the definition of equivariant sheaves.
...
% TODO correspondence b/w equivariant bundles and equivariant sheaves

For $F\to X$ a $G$-equivariant vector bundle, there is a natural linear action of $G$ on the space of
